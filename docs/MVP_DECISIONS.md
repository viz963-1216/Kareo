...
| D-01a | 規則表、關鍵字、Summary 模板、補助說明模板與知識對應（ASSESSMENT_RULES §6） | **SPEC-APPROVED**：r2–r6（2026-09-24；r3 地方資訊模板、r4／r5 身障與估算、r6 臺北市地方紀錄對應） | r6 | Jerry | [PR #31 comment 2026-09-24](https://github.com/viz963-1216/Kareo/pull/31#issuecomment-5806704685)；r6：PR #35 留言（待貼） | B-010、C-005、J-003 |
...
| 已完成（2026-09-24） | `KP-2026-09-24-005` 臺北市地方知識 4 筆與 4 個來源核准；規則表 r6 核准 | — |
