...
| `KP-2026-09-24-005` 修正版（2026-09-24 查核） | KR-2026-019（GPS 資格與先核定）、KR-2026-020（部分負擔適用條件）、KR-2026-021（等級與先核定）待 Jerry 重新核准；規則表 r7 提案（S-EST-LOCAL-AD 文字、T39–T43）待核准；官方網域在查核環境無法連線，原文逐格核對未完成 | Jerry |
