...
| 事項 | 狀態／還需要什麼 | 負責 |
|---|---|---|
| **審核 `KP-2026-09-24-003`**（新北市身心障礙者加碼輔具、醫療輔具 2 筆，來源為 Jerry 指定資料夾）＋**規則表 r4 提案**（兩種新地方紀錄類型的顯示對應） | 2026-09-24 草稿已提交。重點：KR-2026-016 文件無日期；KR-2026-017 標示 102.03.13（2013 年）需確認仍現行；兩筆都屬身心障礙福利、需身障證明 | Jerry |
