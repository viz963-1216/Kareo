...
|---|---|---|---|
| 1 | 同意 → **真實初評**與可能適用的制度／補助說明 | Jerry：D-04（D-02 已核准）；J-003：首次知識發布；B：B-011a → B-010 | C：C-005（Mock）；A：A-003-r2、A-005 |
...
1. **D-03 格式與 D-10 延伸使用補核准**：B-008 已合併但無核准紀錄；首次知識發布會用到這兩項。
2. **D-04 Session 安全 contract**：B-011a 已可開工，核准後才算正式驗收。
3. **D-01a 規則表 r2**：B-010 正式驗收需要。

（D-02 首批 9 筆知識已於 2026-09-24 全部核准，待 J-003 發布。）
...
2. D-02 已核准：在整合環境執行首次知識發布（目標 `KB-2026-09-24-001`）並留證。
...
| 日期 | 目標 |
|---|---|
| 9/26 | D-03／D-04 決定；首次知識發布（整合環境可用時；D-02 已於 9/24 核准） |
