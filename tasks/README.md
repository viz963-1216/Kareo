...
1. **D-04 Session 安全 contract**：B-011a 已可開工，核准後才算正式驗收。
2. **D-01a 規則表 r2**：B-010 正式驗收需要。
3. **D-13a–g 位置細節**：B-005、C-005 正式驗收需要。

（2026-09-24 已核准：D-02 首批 9 筆知識、D-03 內容包格式、D-10 延伸使用。首次發布待 B-008-r2。）
